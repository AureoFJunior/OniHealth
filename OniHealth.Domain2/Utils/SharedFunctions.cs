...
namespace OniHealth.Domain.Utils
{
    public static class SharedFunctions
    {
        ...
        public static async Task<object> GetAsync(string apiEndpoint, string parameters) 
        {
            var response = await _httpClient.GetAsync($"{_apiBaseUrl}/{apiEndpoint}/{parameters}");
