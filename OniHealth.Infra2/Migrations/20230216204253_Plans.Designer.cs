...
namespace OniHealth.Infra.Migrations
{
    ...
    [Migration("20230216204253_Plans")]
    partial class Plans
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OniHealth.Domain.Models.Customer", b =>
                {
                    ...
                    b.Property<int>("SignedPlanId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("SignedPlanId");
            ...
            modelBuilder.Entity("OniHealth.Domain.Models.Customer", b =>
                {
                    b.HasOne("OniHealth.Domain.Models.Plans", "Plans")
                        .WithMany()
                        .HasForeignKey("SignedPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
